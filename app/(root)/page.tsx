      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          <Image
            src={profileImg}
            sizes="100vw"
            className="bg-primary rounded-full mb-0 h-auto md:mb-2 w-[60%] max-w-[16rem] border-8 border-primary object-cover"
            alt="Saud Ahmed - Graphic Designer & Video Editor Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"https://github.com/saudahmed"}
                target="_blank"
                className={cn(buttonVariants({ size: "lg" }))}
                aria-label="View Saud Ahmed's GitHub profile"
              >
